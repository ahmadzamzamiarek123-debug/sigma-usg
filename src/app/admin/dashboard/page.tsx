...
const AdminProdiChart = dynamic(
  () =>
    import("@/components/charts/AdminProdiChart").then((m) => ({
      default: m.AdminProdiChart,
    })),
  {
    loading: () => (
      <div className="animate-pulse h-80 bg-gray-200 dark:bg-gray-700 rounded-xl" />
    ),
    ssr: false,
  }
);
        ...
        <Card className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white border-0 col-span-2 sm:col-span-1">
          <CardContent className="p-4 sm:p-6">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl font-bold truncate">
              {formatRupiah(summary?.totalSystemBalance || 0)}
            </p>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <Card className="bg-white border border-gray-100">
          ...
          <CardContent className="p-3 sm:p-6 space-y-2 sm:space-y-3">
            <Link
              href="/admin/topup"
              className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg sm:rounded-xl hover:bg-gray-50 transition-colors"
            >
